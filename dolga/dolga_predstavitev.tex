...
\begin{frame}
  ...
  \begin{tikzpicture}
    ...
    \draw (3) to (4);
  \end{tikzpicture}\\
  Ali pa kot\\\vspace{3mm}
  \begin{tikzpicture}
    \node (0) at (0.00, 0.00) {};
    \node [style=rn] (1) at (1, 0) {\(\frac\pi2\)};
    \node [style=gn] (2) at (2, 0) {\(\frac\pi2\)};
    \node [style=rn] (3) at (3, 0) {\(\frac\pi2\)};
    \node (4) at (4.00, 0.00) {};
    \draw (0) to (1);
    \draw (1) to (2);
    \draw (2) to (3);
...
\begin{frame}
  \frametitle{Primer: Komplementarnost}
  Uporabimo izrek za kopiranje na obeh straneh
  \begin{center}
    \begin{tikzpicture}
    \node (in) at (0,1) {};
...
\end{frame}
\begin{frame}
  \frametitle{Pravilnost Deutsch-Jozsevega algoritma}
...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node [style=gn] (sg) at (0,2) {\(\cdot\)};
      \node [style=gn] (g) at (1,2) {\(\cdot\)};
      \node [style=gn] (f) at (2,1) {\(\cdot\)};
      \node [style=classi] (x) at (3,1) {x};
      \node [style=rn] (r) at (4,0) {};
      \node [style=gn] (eg) at (4,2) {\(\cdot\)};
      \node [ground, rotate=90] (er) at (5,0) {};
      \draw (sg) to (g);
      \draw (g) to (f);
      \draw (x) to (r);
      \draw (g) to (eg);
    ...
    \end{tikzpicture}
  \end{center}
  Dobimo dve ločeni komponenti. Spodnjo zavržemo, zgornja se pa poenostavi v željeno meritev
\end{frame}
\begin{frame}
  \frametitle{Pravilnost Deutsch-Jozsevega algoritma}
  V primeru, če \(f\) ni konstantna, pride v poštev spodnja stran. Ko testiramo, če je funkcija konstantna, želimo verjetnost \(0\).
  \begin{center}
    \begin{tikzpicture}
      \node [style=gn] (sr) at (0,0) {\(\pi\)};
      \node [style=gn] (sg) at (0,2) {\(\cdot\)};
...
\begin{frame}
  \frametitle{Pravilnost Deutsch-Jozsevega algoritma}
   Zato na drugem vhodu nastavimo fazo \(\pi\), ker \(e^{\pi i}=-1\). Pajek predstavlja \(\bra0 - \bra1\)
  \begin{center}
    \begin{tikzpicture}
    ...
    \end{tikzpicture}
  \end{center} 
  Če damo funkciji za vhod zelenega pajka, pa naredi superpozicijo vseh izhodov in jih sešteje. Ker je funkcija uravnotežena, dobimo \(0\).
